...
export default function Banner() {
  return (
    <>
      <Head>
        <title>cloudsnepalweb | Hero section</title>
        <meta
          name="description"
          content="Cloudnepalweb is the software provider company in Nepal, It has been providing services like website , mobile apps , web apps development services."
        />
      </Head>
      <section id="home">
